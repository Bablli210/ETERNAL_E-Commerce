    ...
    <>
      ...
      <section className="wrap py-16" data-reveal>
        <div className="grain relative aspect-video w-full bg-night text-linen">
          <Figure
            ...
            label="The house film, full bleed — 1:30 brand explainer with voiceover, poster frame [video to add]"
            dark
            sizes="100vw"
          ...
          <ol className="mt-12 grid gap-10 md:grid-cols-3">
            {steps.map((s, i) => (
              <li key={s.n} data-reveal style={{ ["--i" as string]: i }}>
                <Figure name={`house-step-${s.n}`} label={`Step ${s.n} — studio still`} sizes="(min-width: 768px) 33vw, 100vw" className="aspect-[4/3] w-full" />
      ...
      <section className="grain bg-night text-linen">
        <div className="wrap section grid gap-10 lg:grid-cols-[1fr_2fr] lg:items-center">
          <Figure name="house-founder" label="Founder portrait — same light as the packshots" alt="The founder of eternal" dark sizes="320px" className="aspect-[4/5] w-full max-w-[320px]" />
          <div>
